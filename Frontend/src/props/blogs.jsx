...
const formattedDate = new Date(rawDate).toLocaleDateString('en-US', {
  ...
  day: 'numeric'
    ...
    return(
        <>
        <div className="bg-violet-500 mb-5 ml-10 hover:scale-101 rounded-3xl pr-2 mt-5">
        ...
        <div className='text-white text-[20px] ml-12 mt-5 mb-5'>
            <h1 className=' text-black text-[30px] font-sans cursor-pointer' onClick={handleClickTitle}>{props.title}</h1>
